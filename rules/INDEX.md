...
| `automation-gates.md` | 本地验证、提交钩子、CI 和发布状态 | 所有代码任务 |
| `multi-agent-coordination.md` | Codex、Claude Code 或多个 AI 协作 | 多 AI 或交叉审核 |
| `token-management.md` | 定位、搜索和上下文扩展 | 所有任务 |
